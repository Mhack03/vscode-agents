...
|-------|-------|--------------|
| **🔍 Clarifier** | Claude Sonnet 4.5 | Requirements Analysis |
| **🎯 Orchestrator** | Claude Sonnet 4.5 | Coordination |
| **📋 Planner** | GPT-5.2 | Strategy |
| **⚡ Junior Developer** | Gemini 3 Flash | Quick Fixes |
| **🎨 Frontend Developer** | Gemini 3 Pro | Component Implementation |
| **⚙️ Backend Developer** | Claude Opus 4.6 | API Logic & CRUD |
| **🔄 Fullstack Developer** | Gemini 3 Pro | End-to-End Features |
| **🚀 Senior Frontend Developer** | GPT-5.2-Codex | Complex UI Architecture |
| **💎 Senior Backend Developer** | Claude Opus 4.6 | Distributed Systems |
| **🏆 Senior Fullstack Developer** | GPT-5.2-Codex | Complex Integrations |
| **📊 Data Engineer** | Claude Opus 4.6 | Analytics & Data Pipelines |
| **🎨 Designer** | Gemini 3 Pro | Visual Design & Mockups |
| **✍️ Prompt Writer** | Gemini 3 Pro | Prompt Engineering |
| **⚙️ DevOps** | GPT-5.2-Codex | Operations |
| **✅ Reviewer** | Claude Sonnet 4.5 | Quality Assurance |
