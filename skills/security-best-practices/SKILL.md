...
description: Comprehensive security guidelines for building secure web applications. Use when implementing authentication, handling sensitive data (PII, credentials, tokens), validating user input, preventing injection attacks, reviewing code for security vulnerabilities, or applying defense-in-depth principles. Covers OWASP Top 10, XSS prevention, CSRF protection, input sanitization, password hashing (bcrypt/argon2), encryption at rest, rate limiting, CORS, security headers, and dependency auditing.
