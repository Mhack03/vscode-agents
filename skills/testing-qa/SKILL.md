---
name: testing-qa
description: Comprehensive testing and QA practices for JavaScript and TypeScript applications. Use when writing unit tests, integration tests, or E2E tests with Jest, Vitest, or Playwright. Covers test-driven development (TDD), testing pyramid, AAA pattern (Arrange-Act-Assert), mocking and stubbing strategies, async test patterns, test fixtures, code coverage, snapshot testing, and CI/CD test integration.
